...
Button
{
    readonly property string iconPlayer:
    {
        ...
        svg = svg.arg(themeColor.on_surface_variant)
        return svg.arg(itemSize * 2)
    }

    readonly property string iconPlaylists:
    {
        var svg = "data:image/svg+xml;utf8,<svg xmlns=\"http://www.w3.org/2000/svg\" fill=\"%1\" height=\"%2\" width=\"%2\"><path d=\"M32 40q-2.45 0-4.2-1.675t-1.75-4.075q0-2.4 1.675-4.075Q29.4 28.5 31.8 28.5q.8 0 1.575.15.775.15 1.525.5V12H44v3.55h-6.1V34.3q0 2.35-1.725 4.025Q34.45 40 32 40ZM6 31.5v-3h15.3v3Zm0-8.25v-3h23.65v3ZM6 15v-3h23.65v3Z\"/></svg>"
        svg = svg.arg(themeColor.on_surface_variant)
        return svg.arg(itemSize * 2)
    }
